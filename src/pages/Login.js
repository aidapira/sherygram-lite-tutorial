        ...
        <div className="h-screen flex justify-between flex-col overflow-x-hidden">
            ...
            <div className="flex justify-start">
                <div className="h-40 bg-primary w-96 transform: -skew-x-[25deg] -ml-10 flex items-center justify-center">
                    <h1 className="text-center text-6xl font-semibold skew-x-[25deg] text-white">SHEY</h1>
                </div>
            </div>
            ...
            <div className="flex justify-center">
                <div className="w-[420px] flex-col space-y-5 card p-10">
                    ...
                    <hr />
                    <Link to="/register" className="text-[14px] text-primary">NOT YET REGISTERED? CLICK HERE TO REGISTER</Link>
                </div>
            </div>
