    ...
    return (
        <DefaultLayout>
            {post && data && (
                <div>
                    <div className="my-5">
                        <img src={post.imageURL} className="h-52 w-52" />
                    </div>
                    ...
                    <div className="grid grid-cols-5 md:grid-cols-1 gap-5 mt-5">
                        {data.map((user) => {
                            ...
                            return (
                                <div
                                    className={`cursor-pointer card p-5 justify-center items-center flex-col ${alreadySelected && 'border-4 border-primary'}`}
                                    onClick={() => {
                    ...
                    <div>
                        <button
                            className="bg-primary h-10 rounded-sm text-white px-10 mt-5"
                            onClick={sharePost}
                        >
                            Share
                        </button>
